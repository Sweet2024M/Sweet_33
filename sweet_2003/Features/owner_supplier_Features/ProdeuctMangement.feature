Feature: Product Management
  ...
  Scenario: Add a new product
    ...
    And select "Add Product" I fill in the product name "molto" and price "200" and exp date "5/8/2025" 
  ...
  Scenario: Update an existing product
    Given I am logged in as a store owner or material supplier
    When I navigate to the product management dashbored
    And I select "Edit" and choose a product name "molto" and update price "350" and exp date "5/8/2025"
    Then i submit
