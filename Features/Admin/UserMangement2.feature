Feature: User Management
  ...
  Scenario: Update user information
    ...
    And I select "User Management" from the dashboard options
    And I am on the user management page
    When I choose to update the user with oldusername "mohammad123" and I enter the new username "mohammad123" and I enter the new password "1234" 
    And I submit the updated user details
    Then I should see all users in the list
    And I should see a success message "User updated successfully."
    ...
    And I select "User Management" from the dashboard options
    And I am on the user management page
    When I choose to update the user with oldusername "safi" and I enter the new username "safi" and I enter the new password "12345" 
    And I submit the updated user details
    Then I should see all users in the list
    And I should see a success message "User updated successfully."
    ...
    And I select "User Management" from the dashboard options
    And I am on the user management page
    When I choose to update the user with oldusername "saed" and I enter the new username "saed" and I enter the new password "12345" 
    And I submit the updated user details
    Then I should see all users in the list
    And I should see a success message "User updated successfully."
